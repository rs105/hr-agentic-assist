...
if __name__ == "__main__":
    em = EmployeeManager()
    em.add_employee(EmployeeCreate(emp_id = em.get_next_emp_id(), name="Karan Grover", manager_id=None))
    em.add_employee(EmployeeCreate(emp_id = em.get_next_emp_id(), name="Varun Dorahey", manager_id="E001"))
    # emp_id_varun = em.search_employee_by_name("Varun Dorahey")[0]
